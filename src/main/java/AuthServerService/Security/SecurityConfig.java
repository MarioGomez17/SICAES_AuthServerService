...
import AuthServerService.ServicesImplementation.UserDetailServiceImpl;
...
public class SecurityConfig {
    ...
    RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder) {
        RegisteredClient.Builder BuilderAuthClientServiceSICAES = RegisteredClient.withId(UUID.randomUUID().toString())
                .clientId("AuthClientServiceSICAES")
                .clientSecret(passwordEncoder.encode("AuthClientServiceSICAES12345"))
        ...
        RegisteredClient AuthClientServiceSICAES = BuilderAuthClientServiceSICAES.build();
    ...
    OAuth2TokenCustomizer<JwtEncodingContext> jwtTokenCustomizer() {
        return (context) -> {
            if (OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())) {
                ...
                String indentificationNumerUser = userSession.getIdentificationNumber();
                context.getClaims().claims(claims -> {
                    claims.put("idUser", idUser);
                    claims.put("firstNameUser", firstNameUser);
                    claims.put("firsLastNameUser", firsLastNameUser);
                    claims.put("indentificationNumer", indentificationNumerUser);
